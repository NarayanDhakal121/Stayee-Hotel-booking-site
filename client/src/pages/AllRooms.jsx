  ...
  return (
    <>
      <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24">
        <div>
          <div className="flex flex-col items-start text-left">
            ...
            <p className="text-sm md:text-base text-gray-500/90 mt-2">
              Take advantages of our unlimited offers and special packages
            </p>
          </div>
            ...
            >
              ...
              <div className="md:w-1/2 flex flex-col gap-2">
                ...
                <p
                  ...
                  className="text-grey- 800 tet-3xl font-playfair cursor-pointer"
                >
                  {room.hotel.name}
                </p>
                ...
                <div className="flex items-center gap-1 text-grey-500 mt-2 items-sm">
        ...
        {/* filters */}
        <div className="bg-white w-80 not-placeholder-shown:border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16">
          <div
